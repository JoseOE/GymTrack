...
const styles = StyleSheet.create({ confirmation: { gap: spacing.sm, backgroundColor: colors.primarySoft }, confirmationTitle: { ...typography.heading, color: colors.primary }, confirmationText: { ...typography.body, color: colors.textMuted } });
