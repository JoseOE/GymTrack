...
export function ProfileScreen() {
  ...
  return <ProfileForm key={profile.updatedAt} profile={profile} updateProfile={updateProfile} weeklyPlan={weeklyPlan} />;
}

function ProfileForm({ profile, weeklyPlan, updateProfile }: { profile: UserProfile; weeklyPlan: WeeklyPlan; updateProfile: (profile: UserProfile) => Promise<void> }) {
