...
export function ProgressScreen() {
  return (
    <Screen>
      ...
      <View style={styles.section}><SectionTitle detail="4 de 5 sesiones">Objetivo semanal</SectionTitle><Card style={styles.goal}><View style={styles.goalCopy}><Text style={styles.goalValue}>80%</Text><Text style={styles.goalText}>Una sesión más para completar tu semana</Text></View><ProgressBar value={80} /></Card></View>
    </Screen>
  );
}
